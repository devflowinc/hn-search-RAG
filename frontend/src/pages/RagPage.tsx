  ...
  return (
    <main class="bg-[#F6F6F0] sm:bg-hn font-verdana md:m-2 md:w-[85%] mx-auto md:mx-auto text-[13.33px]">
      ...
      <div class="relative flex max-h-[90vh] flex-row bg-zinc-100 dark:bg-zinc-900">
        ...
        <div
          id="topic-layout"
          class="w-full max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-track-neutral-200 scrollbar-thumb-neutral-400 scrollbar-track-rounded-md scrollbar-thumb-rounded-md dark:scrollbar-track-neutral-800 dark:scrollbar-thumb-neutral-600"
        >
          <Navbar
