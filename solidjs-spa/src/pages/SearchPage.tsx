                ...
                <div class="mt-3 text-center sm:mt-5">
                  ...
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      We are doing some work on this demo over the holidays and
                      will be back January 2025! Feel free to reach out to us at{" "}
                      <a class="hover:underline" href="mailto:humans@trieve.ai">
                        humans@trieve.ai
                      </a>{" "}
